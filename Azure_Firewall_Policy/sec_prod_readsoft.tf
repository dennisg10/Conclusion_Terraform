locals {
  sec_prod_readsoft = [
    {
      name                  = "from_facilicom-werkplek_to_FG-RSAPP01P"
      protocols             = ["TCP"]
      ...
      destination_addresses = ["10.4.43.9"]
    ...
    {
      name                  = "SQL_from_FG-RSAPP01P_to_FG-SQL01P"
      protocols             = ["TCP"]
      source_addresses      = ["10.4.43.9"]
      destination_addresses = ["10.4.43.8"]
      destination_ports     = ["${local.services["mysql"]}"]
    },
    {
      name                  = "SMB_from_FG-RSAPP01P_to_DFS.nl.fsg.local"
      protocols             = ["TCP"]
      source_addresses      = ["10.4.43.9"]
    ...
    {
      name                  = "HTTPS_from_FG-RSAPP01P_to_webmail.facilicom.com"
      protocols             = ["TCP"]
      source_addresses      = ["10.4.43.9"]
      destination_addresses = ["92.70.103.79"]
      destination_ports     = ["${local.services["https"]}"]
    },
    {
      name                  = "SMB_from_SAP_to_FG-RSAPP01P"
      protocols             = ["TCP", "UDP"]
    ...
    {
      name                  = "From_FG-RSAPP01P_to_SAP-RS-Director"
      protocols             = ["TCP"]
      source_addresses      = ["10.4.43.9"]
      destination_addresses = ["10.1.49.124", "10.1.49.195"]
